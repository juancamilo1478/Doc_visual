    ...
    <div class="w-screen min-h-screen flex flex-col justify-between bg-gray-100">
        ...
        <div class="w-full flex-grow max-h-screen  flex   lg:overflow-hidden">
            ...
            <div class="w-full  lg:w-1/2   flex justify-center">
                <div class="w-full mx-20 flex flex-col h-full">
                    ...
                    <h2 class=" font-sans text-2xl font-semibold w-md m-auto text-center pt-10">Únete a nuestra
                        comunidad de
                    ...
                    <h3 class="text-center mt-9" style="color: var(--blue-1);">Doc visual <span class="text-black">I legal</span></h3>
