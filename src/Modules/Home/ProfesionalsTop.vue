...
<template>
    <div class="w-screen bg-white py-3">
        <div class="container m-auto">
            <h1 class="text-center px-5 w-full font-poppins text-xl md:text-3xl py-1   font-semibold" style="color: var(--blue-1);">
                Encuentra tu profesional de la salud visual con ubicación y especialidad.
            </h1>
            <h2 class="text-center px-5 w-full font-poppins text-black text-xl md:text-3xl  font-bold ">Seremos tu mejor aliado en el
